...
- `outputs/reproduced/manuscript_tables/table_main_posebench702_external_top1.csv`
- `outputs/reproduced/manuscript_tables/table_public_pool_physical_plausibility.csv`
- `outputs/reproduced/manuscript_tables/table_public_pool_paired_physics_increment.csv`
